...
Many playbooks recommend modelling the response before implementing it. Use [Scenario Intelligence](/guides/scenarios) to create what-if models of the playbook's recommended actions — test the financial impact of a rate review, a staffing change, or a service redesign before committing.
...
See [Free MCP Server Setup](/mcp-and-integrations/free-mcp) for configuration instructions.
...
→ [Service Economics](/service-economics)
