...
- [Excel / CSV Import](/docs/mcp-and-integrations/excel-import) — Bulk import services, engagements, and financial data
- [QuickBooks](/docs/mcp-and-integrations/quickbooks) — Sync invoices and expenses for automated financial tracking
- [Webhooks & API](/docs/mcp-and-integrations/webhooks) — Planned webhook events for workflow automation